...
abstract class Page
{
    ...
    protected function __construct()
    {
        ...
        $this->_database = new MySQLi($host, "public", "public", "2022_Easy2Read");
    ...
    protected function generatePageHeader(string $title = "", string $jsFile = "", bool $autoreload = false):void
    {
        ...
        <meta charset="UTF-8" />
        <title>$title</title>
        <link rel="stylesheet" type="text/css" href="Exam22.css.css"/>
    	<script type="text/javascript" src="Exam22.js.js"></script>
        </head>
